      ...
      <div className="max-w-[1600px] mx-auto space-y-8 pb-12 text-text-primary">
        <header className="flex justify-between items-end">
          ...
          <div className="flex gap-3">
             ...
             <button onClick={() => navigate('/monitoring')} className="btn-primary flex items-center gap-2 px-6">
                SLA Monitor
             ...
             <div className="card !p-0 overflow-hidden border-rose-500/20">
                ...
                <div className="divide-y divide-border-subtle">
                   {stats.crisisAlerts.map(alert => (
                     <div key={alert.id} className="p-5 flex items-center justify-between group hover:bg-rose-500/5 transition-all cursor-pointer" onClick={() => navigate('/monitoring')}>
